    ...
    <section ref={sectionRef} className="vx-section" style={{ backgroundColor: "var(--bg-primary)" }}>
      <div className="vx-container">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1.2fr)_auto_minmax(0,1fr)] lg:items-start"
        >
          <div>
        ...
        >
          <div className="flex min-w-0 flex-col gap-6 sm:flex-row sm:gap-10">
            <h3
              className="min-w-0 font-syne font-extrabold uppercase"
            ...
            <div className="hidden w-px shrink-0 sm:block" style={{ backgroundColor: "var(--divider)" }} />
            <h3
              className="min-w-0 font-syne font-extrabold uppercase"
              style={{ fontSize: "clamp(20px, 2.4vw, 28px)", lineHeight: "1.3", color: "var(--text-primary)" }}
            >
          ...
          <p
            className="min-w-0 shrink-0 font-dm-mono text-right uppercase"
